 ...
 */
import { constructUrl, getParentPath, normalizePathForDisplay, log, showStatus } from './utils.js';
import { getParUrl, setCurrentFolder } from './storage.js';
import { loadDeletedFilesIndex, createDeletedFilesMap, isShowingDeletedFiles } from './deletion-manager.js';
  ...
  try {
    ...
    for (const file of fileArray) {
      try {
        ...
        if (uploadPath) {
          objectName = uploadPath + file.name;
        }
